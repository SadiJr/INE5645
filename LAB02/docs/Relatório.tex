...
{\bf \large ANÁLISE DO PROBLEMA DOS LEITORES E ESCRITORES}\\[3.6 cm]
...
{\bf \large ANÁLISE DO PROBLEMA DOS LEITORES E ESCRITORES}\\[0.5cm]
    \begin{flushright}
    \begin{list}{}{
      ...
      \item Análise de um dos problemas clássicos da programação concorrente, requerido pelo professor da disciplina Programação Paralela e Distribuída, Odorico Machado Mendizabal, necessário para obtenção de nota.\\[0.2 cm] 
      \setlength{\labelsep}{\leftmargin}
